...
let settings = {
    ...
    pages: [
        ...
        { 
            image: './image/photos/2.png', // Menggantikan lhvuck.png (Index 1)
        },

        // --- Lembar 2 (data-page="1") ---
        { 
            image: './image/photos/1.png', // Menggantikan fjr3qh.png (Index 2)
            content: 'Happy Birthday Sayang 💗' 
        },
        { 
            image: './image/photos/3.png', // Menggantikan 8u5tf7.png (Index 3)
        },
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            // --- Lembar 3 (data-page="2") ---
            { 
                image: './image/photos/4.png', // Menggantikan tbutvj.png (Index 4)
                content: 'As long as you’re smiling, I’m happy. Stay happy, my love.' 
            }
        ]
    };
